=== Simple Favorite Posts ===
Contributors: Oleksii
...
Plugin allows you to add posts to favorites. 
It uses cookies. The plugin works with unauthorized users. The plugin allows you to add posts to favorites in which the_content () or the_excerpt () function is used in the output.

== Description ==

The user must choose one of two shortcodes [mark_content] or [mark_excerpt]
- [mark_content] - when the the_content() function was used in the output of posts;
- [mark_excerpt] - when the the_excerpt() function was used in the output of posts;

After adding the shortcode [mark_content] or [mark_excerpt], a gray heart appears above the content or excerpt.
In order to add a post to the list of favorites, you need to click on the gray heart. The heart turns red. In order to remove the post from the favorites, you need to click on the red heart.
To display a list of favorite posts, you need to use the shortcode: 
- [marked_posts]. 
In the list of favorite posts, to remove a post from your favorites, you need to click on the heart 2 times.
